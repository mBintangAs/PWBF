        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Puskesmas Fatimah</h4>
                  <div class="icons-list row">
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-address-book"></i>NAMA PASIEN</div>
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-address-book-o"></i>POLI </div>
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-address-card"></i>DOKTER</div>
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-address-card-o"></i>ANAMNESE</div>
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-bandcamp"></i></div>
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-bath"></i> </div>
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-bathtub"></i> </div>
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-drivers-license"></i> </div>
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-drivers-license-o"></i> </div>
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-eercast"></i> </div>
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-envelope-open"></i> </div>
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-envelope-open-o"></i> </div>
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-etsy"></i> </div>
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-free-code-camp"></i> </div>
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-grav"></i></div>
                    <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-handshake-o"></i> </div>
